...
let timeCount = quiz_box.querySelector(".timer .time_sec");
let timeLine = quiz_box.querySelector("header .time_line");
let timeText = quiz_box.querySelector("header .time_text");

const option_list = document.querySelector(".option_list");

start_btn.onclick = () => {
  start_btn.classList.add("none");
  info_box.classList.remove("none");
};
...
const quit_quiz = result_box.querySelector(".result_box .quit");
